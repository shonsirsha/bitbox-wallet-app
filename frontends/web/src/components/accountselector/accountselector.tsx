    ...
    <div className={styles.singleValueContainer}>
      <components.SingleValue {...props}>
        <div className={styles.valueContainer}>
          ...
          {coinCode && balance && <span className={styles.balanceSingleValue}>{balance} {coinCode.toUpperCase()}</span>}
        </div>
  ...
  return (
    <components.Option {...props}>
      <div className={styles.valueContainer}>
        ...
        {coinCode ? <Logo coinCode={coinCode} alt={coinCode} /> : null}
        <span className={styles.selectLabelText}>{label}</span>
        {coinCode && balance && <span className={styles.balance}>{balance} {coinCode.toUpperCase()}</span>}
      </div>
    </components.Option>
  );
};
