...
import arbitrumSVG from '../icon/assets/arbitrum.svg';
...
import bscSVG from '../icon/assets/bsc.svg';
...
import ethColorSVG from '../icon/assets/eth-color.svg';
import fantomSVG from '../icon/assets/fantom.svg';
...
import optimismSVG from '../icon/assets/optimism.svg';
import polygonSVG from '../icon/assets/polygon.svg';
