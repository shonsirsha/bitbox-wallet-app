...
import { ConfirmingWaitDialog } from '@/routes/account/send/components/dialogs/confirm-wait-dialog';
...
import { MessageWaitDialog } from '@/routes/account/send/components/dialogs/message-wait-dialog';
import { ReceiverAddressInput } from '@/routes/account/send/components/inputs/receiver-address-input';
import { CoinInput } from '@/routes/account/send/components/inputs/coin-input';
