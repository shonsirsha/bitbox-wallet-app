...
import { ManageBackupSetting } from '@/routes/settings/components/device-settings/manage-backup-setting';
import { ShowRecoveryWordsSetting } from '@/routes/settings/components/device-settings/show-recovery-words-setting';
import { GoToStartupSettings } from '@/routes/settings/components/device-settings/go-to-startup-settings';
import { PassphraseSetting } from '@/routes/settings/components/device-settings/passphrase-setting';
import { DeviceInfo, getDeviceInfo, getVersion, getRootFingerprint } from '@/api/bitbox02';
import { alertUser } from '@/components/alert/Alert';
import { Skeleton } from '@/components/skeleton/skeleton';
import { AttestationCheckSetting } from '@/routes/settings/components/device-settings/attestation-check-setting';
import { FirmwareSetting } from '@/routes/settings/components/device-settings/firmware-setting';
import { SecureChipSetting } from '@/routes/settings/components/device-settings/secure-chip-setting';
import { DeviceNameSetting } from '@/routes/settings/components/device-settings/device-name-setting';
import { FactoryResetSetting } from '@/routes/settings/components/device-settings/factory-reset-setting';
import { RootFingerprintSetting } from '@/routes/settings/components/device-settings/root-fingerprint-setting';
import { Bip85Setting } from '@/routes/settings/components/device-settings/bip85-setting';
